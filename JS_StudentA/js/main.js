...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // 밑에 studentList 배열이 새로 만들어질 수도 있으니 let으로 선언하기
  let studentList = [];
  ...
  const addStudent = () => {
    ...
    // studentList.length 3의 값을 가지고 있다
  ...
  const loadStudent = () => {
    ...
    // 혹시 studentList 가 배열이 잘못 만들어져 있으면
    if (!studentList) {
      studentList = [];
    }
  };
