...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const lottoDisp = () => {
    ...
    /**
     * Math.random() 함수는
     * 0.0000 ~ 0.9999999999999 까지 범위에서
     * 임의의 숫자 1개를 만들어 내는 기능
     *
     * 생성된 숫자에 10을 곱하면
     * 0 ~ 9.99999 범위의 수가 만들어진다
     *
     * 이 숫자를 Math.floor() 함수에게 전달하면
     * 0 ~ 9 까지의 범위의 정수를 만들어서 return 한다
     */
    ...
    /**
     * 1 ~ 45까지의 숫자가 저장된 nums 배열을 shuffle 해 보자
     */
  ...
  // event handler 로 사용하는 함수는 ()를 붙여서는 안 된다
